...
import { formatAuto, formatBoolean, formatDate, formatNumber, formatText, LEFT_ALIGNMENT, CENTER_ALIGNMENT, RIGHT_ALIGNMENT, PropertySortType, SortDirection } from '../../services';
...
var DefaultItemActionType = PropTypes.shape({
  ...
  PropTypes.oneOf(ICON_TYPES), PropTypes.func]),
  color: PropTypes.oneOfType([PropTypes.oneOf(BUTTON_ICON_COLORS), PropTypes.func])
});

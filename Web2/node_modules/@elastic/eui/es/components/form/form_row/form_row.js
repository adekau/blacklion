  ...
  _createClass(EuiFormRow, [{
    ...
    value: function render() {
      ...
      if (label) {
        ...
        React.createElement("div", null, React.createElement(EuiFormLabel, {
      ...
      if (labelAppend) {
        optionalLabel = React.createElement(EuiFlexGroup, {
          responsive: false,
          wrap: true,
          gutterSize: "xs",
          ...
          grow: false
        }, optionalLabel), React.createElement(EuiFlexItem, {
          grow: false
        }, labelAppend));
      }

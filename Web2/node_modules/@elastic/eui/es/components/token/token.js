...
export var EuiToken = function EuiToken(_ref) {
  ...
  if (iconType in TOKEN_MAP && displayOptionsIsEmpty) {
    var mapping = TOKEN_MAP[iconType]; // These should be found in the standard mappings, but apply defaults
    // just in case.
...
EuiToken.propTypes = {
  ...
  displayOptions: PropTypes.shape({
    color: PropTypes.oneOf(["tokenTint01", "tokenTint02", "tokenTint03", "tokenTint04", "tokenTint05", "tokenTint06", "tokenTint07", "tokenTint08", "tokenTint09", "tokenTint10", "tokenTint11", "tokenTint12"]),

...
GO
PRINT N'Dropping [Items].[UpdateBagDetail]...';


GO
DROP PROCEDURE [Items].[UpdateBagDetail];


GO
PRINT N'Dropping [Items].[BagDetail]...';


GO
DROP TYPE [Items].[BagDetail];
...
GO
PRINT N'Creating [Items].[UpdateBagDetail]...';
